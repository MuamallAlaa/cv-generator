  ...
  var e = {
      755: function (e, t, n) {
        ...
        var s = i(n(218)),
          ...
          u = document.getElementById("phone"),
          l = document.getElementById("address"),
          f = document.getElementById("about"),
          d = document.getElementById("cvForm"),
          p = document.getElementById("experience"),
          h = document.getElementById("education");
                ...
                return o(this, function (r) {
                  switch (r.label) {
                    ...
                    case 3:
                      return (
                        (n = r.sent()),
                        console.error("Error making POST request:", n),
                        [3, 4]
                      );
                    case 4:
                      return [2];
      ...
      218: (e, t, n) => {
        ...
        const N = c("HTMLFormElement"),
          ...
          F = "0123456789",
          U = { DIGIT: F, ALPHA: B, ALPHA_DIGIT: B + B.toUpperCase() + F },
          L = c("AsyncFunction");
        var D = {
          isArray: l,
          isArrayBuffer: d,
        ...
        D.inherits(pe, k, { __CANCEL__: !0 });
        var he = Y.isStandardBrowserEnv
          ? {
              ...
              return new Promise(function (t, n) {
                ...
                if (
                  (c.open(
                    ...
                    X(u, e.params, e.paramsSerializer),
                    !0
                  ),
                  (c.timeout = e.timeout),
                  "onloadend" in c
                  ...
                  (c.onabort = function () {
                    c &&
                      (n(new k("Request aborted", k.ECONNABORTED, e, c)),
                      (c = null));
                  }),
                  (c.onerror = function () {
          ...
          return (
            ...
            ((e) => {
              ...
              for (
                let o = 0;
                o < t &&
                ((n = e[o]), !(r = D.isString(n) ? be[n.toLowerCase()] : n));
                o++
              );
              if (!r) {
                if (!1 === r)
        ...
        class xe {
          ...
          request(e, t) {
            ...
            void 0 !== n &&
              ...
              (i = o && D.merge(o.common, o[t.method])),
              i &&
                D.forEach(
        ...
        const Be = (function e(t) {
          ...
          return (
            D.extend(o, je.prototype, n, { allOwnKeys: !0 }),
        ...
        (Be.Axios = je),
          ...
          (Be.mergeConfig = Se),
          (Be.AxiosHeaders = le),
          (Be.formToJSON = (e) => ee(D.isHTMLForm(e) ? new FormData(e) : e)),
          (Be.HttpStatusCode = _e),
          (Be.default = Be),
          (e.exports = Be);
      },
    },
